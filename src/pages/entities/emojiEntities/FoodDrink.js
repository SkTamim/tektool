...
const FoodDrink = (props) => {
	...
	const { searchData, searchLoading, searchError, getSearchData } =
		useSearchFirebase("entities/emoji-entities/food-drink", "food-drink");
	...
	const {
		...
		hasMoreData,
		getNextData,
	} = useFetchFromFirebase("entities/emoji-entities/food-drink");
			...
			<Grid container spacing={2} px='14px' pb='20px'>
				<Grid item md={6} xs={12}>
					...
					<div className={classes.copyInfo}>
						...
						>
							Click on any emoji or Code to copy
						</Paragraph>
					</div>
				</Grid>
				<Grid item md={6} xs={12}>
			...
			{!error && !isSharched && (
				<div className={classes.tableContainer}>
					...
					<div style={{ textAlign: "center", marginTop: "20px" }}>
						...
						{hasMoreData && <p>No More Emojies Available...</p>}
					</div>
				</div>
			)}
